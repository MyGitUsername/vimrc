...
" Typescript specific spaces and tabs
" autocmd FileType ts setlocal shiftwidth=4 softtabstop=4
...
" Fuzzy File Finder with F2 TODO FIXME
...
Plug 'ap/vim-css-color' " Whenever it detects a color, it changes the background of that text to the detected color
